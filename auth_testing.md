...
```bash
# Test auth endpoint
curl -X GET "https://barras.facore.cloud/api/auth/me" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

# Test protected endpoints
curl -X GET "https://barras.facore.cloud/api/session-stats" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

curl -X POST "https://barras.facore.cloud/api/barcode" \
...
await page.context.add_cookies([{
    ...
    "domain": "barras.facore.cloud",
    "path": "/",
    "httpOnly": true,
    "secure": true,
    "sameSite": "None"
}]);
await page.goto("https://barras.facore.cloud");
```
...
✅ Barcode scanning and saving works
